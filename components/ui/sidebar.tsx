...
export function Sidebar({ children, collapsible, className }: SidebarProps) {
  return (
    <div
...
export function SidebarRailComponent() {
  return <div className="sidebar-rail"></div>;
}
...
export function SidebarProviderComponent({
  ...
  return <div className="sidebar-provider group">{children}</div>;
}

export function SidebarTriggerComponent({ className }: { className?: string }) {
  return (
    <button className={`sidebar-trigger ${className}`}>
      <span className="sr-only">Toggle sidebar</span>
      <svg
